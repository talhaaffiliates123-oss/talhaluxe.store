                ...
                <div className="space-y-4">
                  ...
                  {paymentMethod === 'card' && (
                     <div className="space-y-4 pt-4 border-t mt-4">
                        {stripe && elements && clientSecret ? <PaymentElement /> : <p>Loading payment form...</p>}
                     </div>
                  )}
                </div>
              </CardContent>
...
export default function CheckoutPage() {
    ...
    const showLoadingSkeleton = userLoading || (items.length > 0 && loadingSecret) || (items.length > 0 && !clientSecret);

    if (userLoading || (items.length === 0 && !userLoading)) {
      return (
