...
export const products: Omit<Product, 'id'>[] = [
  ...
  },
  {
    ...
    discountedPrice: null,
    category: 'bags',
    imageUrls: ['https://i.ibb.co/2kCg2j7/a-brown-leather-bag-sitting-on-top-of-a-wooden-floor.jpg'],
    stock: 10,
    rating: 4.9,
    reviews: [],
    isNewArrival: true,
  ...
  },
  {
    ...
    discountedPrice: null,
    category: 'jewelry',
    imageUrls: ['https://i.ibb.co/yWFCsCg/a-gold-ring-with-a-diamond-on-it.jpg'],
    stock: 8,
    rating: 4.9,
    reviews: [],
    isNewArrival: false,
  ...
  },
  {
    ...
    discountedPrice: null,
    category: 'sunglasses',
    imageUrls: ['https://i.ibb.co/qD4M4Kf/a-pair-of-sunglasses-sitting-on-top-of-a-white-surface.jpg', 'https://i.ibb.co/dGt5B0D/a-pair-of-sunglasses-sitting-on-a-white-surface.jpg'],
    stock: 40,
    rating: 4.8,
    reviews: [],
    isNewArrival: false,
